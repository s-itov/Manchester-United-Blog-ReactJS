...
export const Home = () => {
    return (
        <section className="home">
            ...
            <aside>
                <iframe className="league-table" frameBorder="0" scrolling="no" width="320" height="560"
                ...
                <iframe className="next-game" frameBorder="0" scrolling="no" width="320" height="180"
